...
module.exports = {
    name: 'reject',
    // cooldown: 10,
    description: 'This command is for rejecting a user or role from your temp vc',
...
\`${prefixProfile.prefix}reject @member\`
\`${prefixProfile.prefix}reject member_id\`
\`${prefixProfile.prefix}reject @member1 @member2 member3_id member4_id\`
\`${prefixProfile.prefix}reject @role1 @role2 role3_id role4_id\`
\`${prefixProfile.prefix}reject @member1 member2_id @role1 role2_id\``)
                        ...
                        if (arrWithoutRepeated2.length === 1 && arrWithoutRepeated2[0] === message.author.id) {
                            const msgEmbed = new MessageEmbed()
                                .setColor('#ff0000')
                                .setDescription(`${message.author.username}, you can't reject yourself!`)
                            return message.reply({ embeds: [msgEmbed] })
                                .catch(err => console.log(err));
                        }
                        if (arrWithoutRepeated2.length === 1 && arrWithoutRepeated2[0] === message.guildId) {
                            const msgEmbed = new MessageEmbed()
                                .setColor('#ff0000')
                                .setDescription(`${message.author.username}, you can't reject everyone!2`)
                            return message.reply({ embeds: [msgEmbed] })
                                .catch(console.error);
                        }
                        ...
                        if (arrWithoutRepeated2.length === 2 && arrWithoutRepeated2.includes(message.guildId) && arrWithoutRepeated2.includes(message.author.id)) {
                            const msgEmbed = new MessageEmbed()
                                .setColor('#ff0000')
                                .setDescription(`${message.author.username}, you can't reject yourself or everyone!3`)
                            return message.reply({ embeds: [msgEmbed] })
                                .catch(console.error);
                        }
                                ...
                                for (let i = 0; i < arrWithoutRepeated2.length; i++) {
                                    ...
                                    if (i === arrWithoutRepeated2.length - 1 && valid.length === 1) {
                                        ...
                                        if (thisOne === message.author.id) {
                                            const msgEmbed = new MessageEmbed()
                                                .setColor('#ff0000')
                                                .setDescription(`${message.author.username}, you can't reject yourself!8`)
                                            return botMessage.edit({ embeds: [msgEmbed] })
                                                .catch(console.error);
                                        }
                                        ...
                                        if ((thisOne === message.guild.id)) {
                                            const msgEmbed = new MessageEmbed()
                                                .setColor('#ff0000')
                                                .setDescription(`${message.author.username}, you can't reject everyone!9`)
                                            return botMessage.edit({ embeds: [msgEmbed] })
                                                .catch(console.error);
                                        }
                                    }
                                    if (i === arrWithoutRepeated2.length - 1 && valid.length === 2) {
                                        ...
                                        if ((thisOne === message.guild.id && thisOne1 === message.author.id) || (thisOne1 === message.guild.id && thisOne === message.author.id)) {
                                            const msgEmbed = new MessageEmbed()
                                                .setColor('#ff0000')
                                                .setDescription(`${message.author.username}, you can't reject everyone or yourself!10`)
                                            return botMessage.edit({ embeds: [msgEmbed] })
                                                .catch(console.error);
                                        }
                                    }
                                ...
                                for (let i = 0; i < valid.length; i++) {
                                    ...
                                    if (user) {
                                        await message.guild.members
                                            ...
                                            .then(async member => {
                                                ...
                                                if (isUserHasPerm) {
                                                    await authorVC.permissionOverwrites.edit(member, { CONNECT: false, VIEW_CHANNEL: null })
                                                        .catch(console.error);
                                    ...
                                    const permittedChecker = () => {
                                        if (permitted.length >= 1) {
                                            return `**${message.author.username}, you have successfully rejected:**
