...
\`${serverProfile.prefix}reject @member\`
\`${serverProfile.prefix}reject member_id\`
\`${serverProfile.prefix}reject @member1 @member2 member3_id member4_id\`
\`${serverProfile.prefix}reject @role1 @role2 role3_id role4_id\`
\`${serverProfile.prefix}reject @member1 member2_id @role1 role2_id\``)
