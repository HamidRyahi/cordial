...
\`${prefixProfile.prefix}permit @member\`
\`${prefixProfile.prefix}permit member_id\`
\`${prefixProfile.prefix}permit @member1 @member2 member3_id member4_id\`
\`${prefixProfile.prefix}permit @role1 @role2 role3_id role4_id\`
\`${prefixProfile.prefix}permit @member1 member2_id @role1 role2_id\``)
